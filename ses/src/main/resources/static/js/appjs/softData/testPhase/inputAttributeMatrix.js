...
var attributeMatrixArray = document.getElementsByName("attributeMatrixArrayInTestPhase[]");
...
function saveArray() {
    ...
    localStorage.setItem('attributeMatrixArrayInTestPhase', JSON.stringify(arrayNew));
}
...
$(document).ready(function () {
    var arrayOld = JSON.parse(localStorage.getItem('attributeMatrixArrayInTestPhase'));
    if(arrayOld != null){
...
$("#nextStep").click(function () {
    window.location.href = "/softData/testPhase/inputSubAttributeMatrix";
})