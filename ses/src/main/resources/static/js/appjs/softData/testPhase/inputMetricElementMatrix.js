...
var metricElementMatrixArray = document.getElementsByName("metricElementMatrixArrayInTestPhase[]");
...
function saveArray() {
    ...
    localStorage.setItem('metricElementMatrixArrayInTestPhase', JSON.stringify(arrayNew));
}
...
$(document).ready(function () {
    var arrayOld = JSON.parse(localStorage.getItem('metricElementMatrixArrayInTestPhase'));
    if(arrayOld != null) {
...
$("#submitData").click(function () {
    ...
    zhenghufanMatrix = {
        "metricElementMatrixArray": localStorage.getItem('metricElementMatrixArrayInTestPhase'),
        "subAttributeMatrixArray": localStorage.getItem('subAttributeMatrixArrayInTestPhase'),
        "attributeMatrixArray": localStorage.getItem('attributeMatrixArrayInTestPhase')
    };
    $.ajax({
        type:"POST",
        async:false,
        ...
        url:"/softData/testPhase/countWeightByMatrix",
        ...
        success:function(data){
            if(data.code == 1){
                ...
                alert("提交成功！");
                window.location.href = "/softData/testPhase/displayWeight";
            }
        }
    });
})
